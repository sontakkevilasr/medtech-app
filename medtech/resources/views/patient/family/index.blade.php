...
@php
    ...
    $selfInit  = strtoupper(substr($self->full_name, 0, 1));
...
<div style="background:#fff;border:1.5px solid var(--warm-bd);border-radius:14px;overflow:hidden;margin-bottom:18px;transition:box-shadow .15s"
    ...
    <div style="background:linear-gradient(135deg,{{ $selfColor }} 0%,{{ $selfColor }}dd 100%);padding:14px 20px;display:flex;align-items:center;justify-content:space-between;gap:12px">
        <div style="display:flex;align-items:center;gap:12px;min-width:0">
            ...
            <div style="min-width:0">
                <div style="font-size:1rem;font-weight:600;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">{{ $self->full_name }}</div>
                <div style="font-size:.72rem;color:rgba(255,255,255,.75);margin-top:2px">
                    {{ $selfDob }}{{ $selfAgeSx }} · {{ $selfGen }}
                </div>
            </div>
        </div>
        <span style="font-size:.66rem;font-weight:700;letter-spacing:.08em;padding:3px 9px;border-radius:20px;background:rgba(255,255,255,.2);color:#fff;flex-shrink:0">
            SELF
        </span>
    </div>
    ...
    <div style="padding:12px 20px;display:flex;align-items:center;gap:10px;border-bottom:1px solid var(--warm-bd)">
        ...
        <div style="display:flex;gap:5px;flex-shrink:0">
            <button type="button"
                    onclick="navigator.clipboard.writeText('{{ $selfId }}').then(()=>{ const b=this; const orig=b.innerHTML; b.innerHTML='<svg width=&quot;13&quot; height=&quot;13&quot; fill=&quot;none&quot; viewBox=&quot;0 0 24 24&quot; stroke=&quot;currentColor&quot; stroke-width=&quot;2.5&quot;><path stroke-linecap=&quot;round&quot; stroke-linejoin=&quot;round&quot; d=&quot;M5 13l4 4L19 7&quot;/></svg>'; setTimeout(()=>b.innerHTML=orig,1500) })"
    ...
    <div style="padding:10px 20px;display:flex;gap:6px;justify-content:flex-end;align-items:center">
        ...
        <a href="{{ route('patient.family.edit', $self->id) }}"
           style="font-size:.75rem;font-weight:500;padding:5px 11px;border:1.5px solid var(--warm-bd);border-radius:8px;color:var(--txt-md);text-decoration:none;transition:all .12s"
           onmouseover="this.style.background='var(--parch)'" onmouseout="this.style.background='transparent'">
            Edit
        </a>
    ...
    <div style="position:relative;z-index:1">
        <div style="display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:16px">
            <div>
                ...
                <div style="font-size:1.1rem;font-weight:600;color:#fff;margin-top:8px">
                    {{ $patientName }}
                </div>
            ...
            {{-- Copy + share buttons (View/Edit live on the self-card above) --}}
            <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:flex-start">
                <button type="button"
                        onclick="navigator.clipboard.writeText('{{ $selfId }}').then(()=>{ const b=this; b.textContent='✓ Copied!'; setTimeout(()=>b.innerHTML='<svg width=&quot;13&quot; height=&quot;13&quot; fill=&quot;none&quot; viewBox=&quot;0 0 24 24&quot; stroke=&quot;currentColor&quot; stroke-width=&quot;2&quot;><rect x=&quot;9&quot; y=&quot;9&quot; width=&quot;13&quot; height=&quot;13&quot; rx=&quot;2&quot;/><path stroke-linecap=&quot;round&quot; stroke-linejoin=&quot;round&quot; d=&quot;M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1&quot;/></svg> Copy ID',2000) })"
